...
urlpatterns = [
    ...
    path("submit-request/", views.submit_exam_request, name="submit_exam_request"), 
    path("request-review/", views.request_review, name="request_review"),
    path("submit-review-request/", views.submit_review_request, name="submit_review_request"), # New URL for submitting request
    ...
    path("approve-request/<int:pk>/", views.approve_request_fbv, name="approve_request"),  # Acción Aprobar - Updated to FBV
    path("reject-request/<int:pk>/", views.reject_request_fbv, name="reject_request"),  # Acción Rechazar - Updated to FBV# Generic Calendar URL - remove or make it redirect based on role if needed
